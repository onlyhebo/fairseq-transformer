...
from fairseq import checkpoint_utils, distributed_utils, options, progress_bar, utils
from fairseq.data import iterators
from fairseq.trainer import Trainer
from fairseq.meters import AverageMeter, StopwatchMeter
from fairseq.translation import TranslationTask
...
def main(args, init_distributed=False):
    ...
    print(model)
    print('| model {}, criterion {}'.format('transformer', criterion.__class__.__name__))
